  ...
  if (!agentRoomScopes.has(scope)) {
    ...
    agentRoomScopes.set(scope, {
      ...
      members: scope === "mention-status-room" ? [
        ...
        {
          principal: "hermes", kind: "agent", display_name: "Hermes", role: "member", mention_token: "@Hermes",
          host: "s1", can_post: true, can_mention: true, mentionable: true,
          profile: {
            summary: "Routes work and coordinates the Room.",
            capabilities: ["Owner routing", "Cross-agent coordination"],
            best_for: ["New and cross-domain requests"],
            boundaries: ["Profile data grants no additional authority"],
            fallback: "Ask the operator for a decision.",
          },
        },
        ...
        { principal: "pla", kind: "agent", display_name: "protoLabs Agent", role: "member", mention_token: "@PLA", host: "pc1", can_post: true, can_mention: true, mentionable: true },
      ] : scope === "multi-room" ? [
        { principal: "dennis", kind: "human", display_name: "Dennis", role: "owner", mention_token: "@Dennis", host: "operator", can_post: true, can_mention: true, mentionable: false },
        { principal: "pc1", kind: "host", display_name: "PC1", role: "member", mention_token: "@PC1", host: "pc1", can_post: true, can_mention: false, mentionable: false },
